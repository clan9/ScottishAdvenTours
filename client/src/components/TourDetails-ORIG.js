        ...
        {loading ? (
          ...
          <Fragment>
            <div className="tour-details">
              <div className="tour-details__showcase">
                <div className="tour-details__showcase__gallery">
                  <Slideshow tourCode={tour.tourCode} />
                </div>

                <div className="tour-details__showcase__text">
                  {highlights &&
                    highlights.map((item, index) => (
                      <div
                        key={index}
                        className="tour-details__showcase__text__item"
                      >
                        <img
                          src={item.icon}
                          className="tour-details__showcase__text__item--icon"
                        ></img>
                        <p className="tour-details__showcase__text__item--content">
                          {item.text}
                        </p>
                      </div>
                    ))}
              ...
              <div className="tour-details__duration">
                ...
                <p className="tour-details__duration__text">
                  Please choose <span>either</span> the start date or end date
                  for your tour below:{" "}
                </p>
          ...
          <Fragment>
            <div className="tour-details">
              ...
              <div className="tour-details__showcase">
                ...
                <div className="tour-details__showcase__gallery">
                  <Gallery tourCode={tour.tourCode} />
                </div>
              </div>
